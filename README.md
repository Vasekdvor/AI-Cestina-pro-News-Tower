...
<!-- Screenshoty ulož do složky "screenshots/" v repozitáři a odkazuj na ně níže. -->

<!-- Dva obrázky vedle sebe (např. porovnání) -->
| Ukázka ze hry | Herní menu |
|:---:|:---:|
| ![Ukázka ze hry](screenshots/screen_cz_news_tower_1.jpg) | ![Herní menu](screenshots/screen_cz_news_tower_3.jpg) |
...
4. Spusť hru a v **Nastavení → Jazyk** zvol **„Polski"** (v menu u volby jazyka bude "polski" to je v pořádku)
5. Jelikož ti hra sdělí že pro zavedení změny jazyka je potřeba restart hry -> proveď restart hry.
6. Voalá... hra by měla být v češtině 🇨🇿.
...
Další možností odinstalace je provést Ověření integrity souborů hry přes steam.
